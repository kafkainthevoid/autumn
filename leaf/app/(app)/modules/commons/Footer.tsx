...
const CustomLink: React.FC<CustomLinkProps> = ({ text, link }) => {
  return (
    <Button variant="link" size="sm" className="text-xs underline text-teal-600">
      {text}
      ...
      <div className="container">
        <div className="flex justify-between">
          <div>
            ...
            <div className="flex gap-6">
              <div className="border-r-[1px] pr-6">
                ...
                <div className="text-xs text-zinc-500 text-center">Call us, it&#39;s toll free</div>
              </div>
              <div>
                <div className="text-teal-600 font-bold">
                  Customer Support <CopyIcon className="w-3 h-3 text-teal-600 inline-block" />
                </div>
                <div className="text-xs text-zinc-500 text-center">Online service assistance</div>
              </div>
            </div>
          </div>
          <div className="grid grid-cols-2 justify-items-start">
            ...
            <CustomLink link="#" text="Autumn Hotlines" />
        ...
        <div className="text-zinc-500 text-xs">©{new Date().getFullYear()} Autumn</div>
      </div>
    </div>
  )
}
