            ...
            <AlertDialogDescription>
              <div className="flex gap-9">
                ...
                >
                  ...
                  <p>Staff</p>
                  {selectedRole === "STAFF" && <CheckCheckIcon className="w-4 h-4 ml-2" />}
                </div>
                <div
                  className={cn(
                    "flex items-center font-bold gap-3 px-3 py-2 rounded-3xl border-teal-500 border-2 text-teal-500 cursor-pointer",
                    selectedRole === "USER" && "bg-teal-600 text-white"
                  )}
                  onClick={() => setSelectedRole("USER")}
                >
                  <UserIcon className="w-4 h-4" />
                  <p>Customer</p>
                  {selectedRole === "USER" && <CheckCheckIcon className="w-4 h-4 ml-2" />}
                </div>
              </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
